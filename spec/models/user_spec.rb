...
describe User do
  ...
  describe "when email format is invalid" do
    it "should be invalid" do
      addresses = %w[ser@foo,com user_at_foo.org example.user@foo. foo@bar_baz.com foo@bar+baz.com]
  ...
  describe "when the email address is already token" do
    before do
  ...
  describe "when the email address is already token uppercase or lowercase" do
    before do
      user_with_same_address = @user.dup
